<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="rengøring.aspx.cs" Inherits="Shop_rengøring" Title="Untitled Page" %>
...
<div class="shopbox">
    <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource1" 
        ...
        <ItemTemplate>
            ...
            <br />
            ml:
            <asp:Label ID="mlLabel" runat="server" Text='<%# Eval("ml") %>' />
            <br />
            <br />
        </ItemTemplate>
    </asp:DataList>
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ConnectionString="Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\rengøring.mdf;Integrated Security=True;User Instance=True" 
        ProviderName="System.Data.SqlClient" 
        SelectCommand="SELECT [Billede], [Navn], [Pris], [ml] FROM [Table1]"></asp:SqlDataSource>
</div>
