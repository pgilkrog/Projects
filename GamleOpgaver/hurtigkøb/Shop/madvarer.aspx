<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="madvarer.aspx.cs" Inherits="Shop_madvarer" Title="Untitled Page" %>
...
<div class="shopbox">
    <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource1" 
        ...
        <ItemTemplate>
            ...
            <br />
            g:
            <asp:Label ID="gLabel" runat="server" Text='<%# Eval("g") %>' />
            <br />
            <br />
        </ItemTemplate>
    </asp:DataList>
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ConnectionString="Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\madvarer.mdf;Integrated Security=True;User Instance=True" 
        ProviderName="System.Data.SqlClient" 
        SelectCommand="SELECT [Billede], [Navn], [Pris], [g] FROM [Table1]"></asp:SqlDataSource>
    </div>
